...
using System.Text;
using Tinkoff_Invest.WebApi.Common;
...
public class InstrumentsServiceSample
{
    ...
    public InstrumentsServiceSample(InvestApiClient investApiClient)
    {
        _service = investApiClient.Instruments;
    }
    ...
    public async Task<string> GetInstrumentsDescriptionAsync(CancellationToken cancellationToken)
    {
        ...
        var dividends = new List<GetDividendsResponse>(Capacity);
        ...
        var accruedInterests = new List<GetAccruedInterestsResponse>(Capacity);
        ...
        var futuresMargin = new List<GetFuturesMarginResponse>(Capacity);
